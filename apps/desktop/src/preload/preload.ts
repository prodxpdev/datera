...
contextBridge.exposeInMainWorld('dateraBridge', {
  ...
  proposeSchema: (text: string) => call(IPC.proposeSchema, text),
  applySchema: (datasetId: string, proposal: unknown) => call(IPC.applySchema, datasetId, proposal),
  ...
  storageUsage: () => call(IPC.storageUsage),
  removeStorage: (id: string) => call(IPC.removeStorage, id),
  resetSettings: () => call(IPC.resetSettings),
  removalInstruction: () => call(IPC.removalInstruction),
  servingStatus: () => call(IPC.servingStatus),
  startServing: (port?: number) => call(IPC.startServing, port),
  stopServing: () => call(IPC.stopServing),
  rotateServingToken: () => call(IPC.rotateServingToken),
