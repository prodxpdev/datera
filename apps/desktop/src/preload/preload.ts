...
contextBridge.exposeInMainWorld('dateraBridge', {
  ...
  listWorkbookSheets: (path: string) => call(IPC.listWorkbookSheets, path),
  ...
  warmChatModel: () => call(IPC.warmChatModel),
  ...
  listReachableDatasets: () => call(IPC.listReachableDatasets),
