  ...
  it('isolates the renderer from Node and from the core', async () => {
    ...
    expect([...probe.bridgeKeys].sort()).toEqual(
      [
        ...
        'queryTraceLog', 'removalInstruction', 'removeSource', 'removeStorage',
        'resetSettings', 'rotateServingToken', 'semanticSearch', 'storageUsage',
        'servingStatus', 'startServing', 'stopServing', 'setApiKey', 'setChatModel',
